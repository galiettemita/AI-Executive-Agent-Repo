...
- [ ] Billing middleware: MCP budget caps (monthly MCP cost tracking + enforcement) (Ops Blueprint Component 1; MCP Integration Spec cost tracking)
...
- [ ] Auth (staging+prod): configure Twilio SMS OTP credentials (`TWILIO_ACCOUNT_SID`, `TWILIO_AUTH_TOKEN`, `TWILIO_PHONE_NUMBER`) and validate link-channel SMS delivery (Ops Blueprint Component 2)
