...
export function EcsStack({ stack }: StackContext) {
    ...
    stack.stage === "dev"
      ? new secretsmanager.Secret(stack, "AppSecrets", {
          ...
          secretObjectValue: {
            ...
            BRAVE_API_KEY: SecretValue.unsafePlainText("CHANGEME"),
            NOTION_API_KEY: SecretValue.unsafePlainText("CHANGEME"),
            TODOIST_API_TOKEN: SecretValue.unsafePlainText("CHANGEME"),
            GITHUB_APP_ID: SecretValue.unsafePlainText("CHANGEME"),
            GITHUB_APP_PRIVATE_KEY: SecretValue.unsafePlainText("CHANGEME"),
            GITHUB_INSTALLATION_ID: SecretValue.unsafePlainText("CHANGEME"),
            ...
            STRIPE_WEBHOOK_SECRET: SecretValue.unsafePlainText("CHANGEME"),
            STRIPE_PRICE_ID_PERSONAL: SecretValue.unsafePlainText("CHANGEME"),
            STRIPE_PRICE_ID_PROFESSIONAL: SecretValue.unsafePlainText("CHANGEME"),
            ...
            TWILIO_ACCOUNT_SID: SecretValue.unsafePlainText(""),
            TWILIO_AUTH_TOKEN: SecretValue.unsafePlainText(""),
            TWILIO_PHONE_NUMBER: SecretValue.unsafePlainText(""),
            ...
            FEATURE_DOCUMENT_PROCESSING: SecretValue.unsafePlainText("true"),
            FEATURE_PRIVILEGE_ISOLATION: SecretValue.unsafePlainText("false"),
            FEATURE_PROFILING_ENABLED: SecretValue.unsafePlainText("true"),
            FEATURE_CONSOLIDATION_ENABLED: SecretValue.unsafePlainText("true"),
            FEATURE_SELF_REVIEW_ENABLED: SecretValue.unsafePlainText("true"),
            FEATURE_MCP_CLIENT: SecretValue.unsafePlainText("true"),
            MCP_HOST_TOKEN: SecretValue.unsafePlainText(""),
            MCP_WAVE1_TRANSPORT_MODE: SecretValue.unsafePlainText("mock"),
            MCP_GOOGLE_CALENDAR_URL: SecretValue.unsafePlainText(""),
            MCP_GOOGLE_DRIVE_URL: SecretValue.unsafePlainText(""),
            MCP_GMAIL_URL: SecretValue.unsafePlainText(""),
            MCP_NOTION_URL: SecretValue.unsafePlainText(""),
            MCP_TODOIST_URL: SecretValue.unsafePlainText(""),
            MCP_BRAVE_SEARCH_URL: SecretValue.unsafePlainText(""),
            MCP_GITHUB_URL: SecretValue.unsafePlainText(""),
            MCP_APPLE_REMINDERS_URL: SecretValue.unsafePlainText(""),
          },
        })
  ...
  const secretEnv = {
    ...
    BRAVE_API_KEY: ecs.Secret.fromSecretsManager(appSecrets, "BRAVE_API_KEY"),
    NOTION_API_KEY: ecs.Secret.fromSecretsManager(appSecrets, "NOTION_API_KEY"),
    TODOIST_API_TOKEN: ecs.Secret.fromSecretsManager(appSecrets, "TODOIST_API_TOKEN"),
    GITHUB_APP_ID: ecs.Secret.fromSecretsManager(appSecrets, "GITHUB_APP_ID"),
    GITHUB_APP_PRIVATE_KEY: ecs.Secret.fromSecretsManager(appSecrets, "GITHUB_APP_PRIVATE_KEY"),
    GITHUB_INSTALLATION_ID: ecs.Secret.fromSecretsManager(appSecrets, "GITHUB_INSTALLATION_ID"),
    ...
    STRIPE_PRICE_ID_PERSONAL: ecs.Secret.fromSecretsManager(appSecrets, "STRIPE_PRICE_ID_PERSONAL"),
    STRIPE_PRICE_ID_PROFESSIONAL: ecs.Secret.fromSecretsManager(appSecrets, "STRIPE_PRICE_ID_PROFESSIONAL"),
    ...
    TWILIO_PHONE_NUMBER: ecs.Secret.fromSecretsManager(appSecrets, "TWILIO_PHONE_NUMBER"),
    ...
    FEATURE_MCP_CLIENT: ecs.Secret.fromSecretsManager(appSecrets, "FEATURE_MCP_CLIENT"),
    MCP_HOST_TOKEN: ecs.Secret.fromSecretsManager(appSecrets, "MCP_HOST_TOKEN"),
    MCP_WAVE1_TRANSPORT_MODE: ecs.Secret.fromSecretsManager(appSecrets, "MCP_WAVE1_TRANSPORT_MODE"),
    MCP_GOOGLE_CALENDAR_URL: ecs.Secret.fromSecretsManager(appSecrets, "MCP_GOOGLE_CALENDAR_URL"),
    MCP_GOOGLE_DRIVE_URL: ecs.Secret.fromSecretsManager(appSecrets, "MCP_GOOGLE_DRIVE_URL"),
    MCP_GMAIL_URL: ecs.Secret.fromSecretsManager(appSecrets, "MCP_GMAIL_URL"),
    MCP_NOTION_URL: ecs.Secret.fromSecretsManager(appSecrets, "MCP_NOTION_URL"),
    MCP_TODOIST_URL: ecs.Secret.fromSecretsManager(appSecrets, "MCP_TODOIST_URL"),
    MCP_BRAVE_SEARCH_URL: ecs.Secret.fromSecretsManager(appSecrets, "MCP_BRAVE_SEARCH_URL"),
    MCP_GITHUB_URL: ecs.Secret.fromSecretsManager(appSecrets, "MCP_GITHUB_URL"),
    MCP_APPLE_REMINDERS_URL: ecs.Secret.fromSecretsManager(appSecrets, "MCP_APPLE_REMINDERS_URL"),
  };
