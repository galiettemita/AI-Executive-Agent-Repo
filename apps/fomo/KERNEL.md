...
| 3C.4 | Founder real-Gmail smoke test with ranker active — same shape as 3B.3 but with real model calls on real founder inbox. Leak-canary scan over `rank_results` + audit. **Next gate.** |
