...
class Settings(BaseSettings):
    ...
    MCP_WAVE2_TRANSPORT_MODE: str = "mock"  # mock | streamable_http | stdio
    MCP_SLACK_URL: str | None = None
    MCP_OUTLOOK_URL: str | None = None
    MCP_TEAMS_URL: str | None = None
    MCP_LINEAR_URL: str | None = None
    MCP_ASANA_URL: str | None = None
    MCP_DISCORD_URL: str | None = None
    MCP_WHATSAPP_BUSINESS_URL: str | None = None
    MCP_WAVE3_TRANSPORT_MODE: str = "mock"  # mock | streamable_http | stdio
    MCP_STRIPE_URL: str | None = None
    MCP_QUICKBOOKS_URL: str | None = None
    MCP_HUBSPOT_URL: str | None = None
    MCP_SALESFORCE_URL: str | None = None
    MCP_GOOGLE_SHEETS_URL: str | None = None
    MCP_AIRTABLE_URL: str | None = None
    MCP_JIRA_URL: str | None = None
    MCP_SENTRY_URL: str | None = None
    MCP_WAVE4_TRANSPORT_MODE: str = "mock"  # mock | streamable_http | stdio
    MCP_GOOGLE_MAPS_URL: str | None = None
    MCP_UBER_LYFT_URL: str | None = None
    MCP_OPENTABLE_RESY_URL: str | None = None
    MCP_HOMEASSISTANT_URL: str | None = None
    MCP_SPOTIFY_URL: str | None = None
    MCP_EVERNOTE_URL: str | None = None
    MCP_DROPBOX_URL: str | None = None
