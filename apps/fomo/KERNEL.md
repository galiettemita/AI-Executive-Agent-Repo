...
- [ ] **Founder has executed the smoke test on the real founder Gmail with real OpenAI calls and committed `docs/SMOKE_REPORT_3C4.md` with `VERDICT: PASS`** (load-bearing — Phase 3D may NOT begin until checked. The PR stays open through the founder's run; "scaffolding committed" is not "phase complete.")
